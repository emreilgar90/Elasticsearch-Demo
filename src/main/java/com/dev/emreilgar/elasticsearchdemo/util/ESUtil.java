package com.dev.emreilgar.elasticsearchdemo.util;
...
/**************************************************************************************************/
    ...
    private static BoolQuery boolQuery(String key1, String value1, String key2, String value2) {
        return new BoolQuery.Builder()
                .filter(termQuery(key1,value1))  //->termQuery birebir eşleşme istediğimiz de
                .must(matchAllQuery(key2,value2)) //matchQuery bir kısmı eşleşse yeter,
                .build();
    }
    ...
    /**************************************************************************************************/
    //termQuery mail sorgusu gibi kesin eşleşmesi gereken sorgularda
    ...
    public static Query matchAllQuery(String field,String value){
